...
- 🎤 **歌词显示** - 支持 LRC 歌词、全屏歌词与桌面歌词（毛玻璃 / 锁定穿透）；本地音乐可批量在线匹配；列表右键与全屏均可多候选预览后挑选；歌词与歌声不同步时可手动校准偏移（每曲独立，实时生效并持久化）
- 🖼️ **匹配封面** - 列表右键与全屏均可多候选预览选图（也可选本地图片）；本地音乐可批量匹配无封面歌曲（MP3 写 Tag，非 MP3 仅更新应用内封面）
...
### v1.2.3 更新内容
- **匹配封面** - 在线匹配专辑封面；列表右键与全屏均可多候选预览选图（也可选本地图片）；本地音乐批量匹配无封面歌曲；MP3 写入文件 Tag，非 MP3 仅更新应用内封面
