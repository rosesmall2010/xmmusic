...
- ❤️ **收藏功能** - 快速收藏喜欢的音乐
- 🎧 **高品质播放** - 原生 Audio 为主（Howler.js 兜底），支持多种音频格式；播放模式含列表顺序 / 随机 / 列表循环 / 单曲循环，上一首/下一首严格跟随所选模式
...
### v1.1.9 更新内容
- 在 v1.1.8 性能与特效开关改进之上发布；安装包与文档版本号同步为 v1.1.9
- **标签编辑增强** - 年份/流派可手动编辑；支持单字段或整包 GB2312/GBK 转换，避免流派等字段仍乱码
...
- **状态持久化优化** - 播放进度高频保存不再整表序列化队列；失效队列曲目启动时自动清理
