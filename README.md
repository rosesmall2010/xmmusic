...
- 🖥️ **全屏播放** - 霓虹频谱 / 蓝色火焰 / 闪电 / 经典唱片四套特效可切换；顶栏可单独关闭频谱类动画；重启后记住上次选择
- 📱 **迷你模式** - 简洁的迷你播放器窗口
...
- **macOS**（仅 Apple Silicon / arm64）: `xmmusic-1.2.0-arm64.dmg`
- **Windows**: `xmmusic Setup 1.2.0.exe`
- **Linux**: `xmmusic-1.2.0.AppImage`
