...
- 🖥️ **全屏播放** - 霓虹频谱 / 蓝色火焰 / 闪电 / 经典唱片 / CD / 磁带特效可切换；顶栏可单独关闭频谱类动画；重启后记住上次选择
- 📱 **迷你模式** - 简洁的迷你播放器；封面可在无特效 / 唱片 / CD / 磁带间切换，并与全屏特效双向同步
...
- **全屏播放特效**：进入全屏播放页 → 顶栏特效按钮循环切换「霓虹频谱 / 蓝色火焰 / 闪电 / 经典唱片」；可用「开启/关闭特效」单独关掉频谱类背景动画（唱片不受影响）；选择会记住
